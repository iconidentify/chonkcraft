...
rm -f \
  ...
  "${repo_root}/engine/target/surefire-reports/TEST-net.chonkbase.chonkcraft.engine.BattleNetMiningStopRealDataTest.xml" \
  "${repo_root}/engine/target/surefire-reports/TEST-net.chonkbase.chonkcraft.engine.BattleNetVillageRescueRealDataTest.xml" \
...
inventory = (
    ...
    ("engine", "BattleNetMiningStopRealDataTest", 3),
    ("engine", "BattleNetVillageRescueRealDataTest", 2),
...
print("control-liveness inventory: 67 pass, 0 skipped")
PY
