...
# verified almost nothing. 991 of 2,627 tests skip that way. This prints the
...
if [[ "$wc2_ok" == 1 && "$pack_ok" == 1 && "$opus_ok" == 1 ]]; then
    ...
    printf '  Expect 2627 tests, 25 skipped, and about four minutes of wall time.\n'
    ...
    printf '  with no input at all, 991 of 2627 tests skip.\n'
