...
# verified almost nothing. 681 of 2118 tests skip that way. This prints the
...
if [[ "$wc2_ok" == 1 && "$pack_ok" == 1 && "$opus_ok" == 1 ]]; then
    ...
    printf '  Expect 2118 tests, 17 skipped, and about four minutes of wall time.\n'
    ...
    printf '  with no input at all, 681 of 2118 tests skip and the run takes 25 seconds.\n'
