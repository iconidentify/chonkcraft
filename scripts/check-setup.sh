...
# verified almost nothing. 1,022 of 2,592 tests skip that way. This prints the
...
if [[ "$wc2_ok" == 1 && "$pack_ok" == 1 && "$opus_ok" == 1 ]]; then
    ...
    printf '  Expect 2592 tests, 25 skipped, and about four minutes of wall time.\n'
    ...
    printf '  with no input at all, 1022 of 2592 tests skip.\n'
