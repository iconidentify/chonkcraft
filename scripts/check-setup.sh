...
# verified almost nothing. 1,176 of 2,783 tests skip that way. This prints the
...
if [[ "$wc2_ok" == 1 && "$pack_ok" == 1 && "$opus_ok" == 1 ]]; then
    ...
    printf '  Expect 2783 tests, 26 skipped, and about four minutes of wall time.\n'
    ...
    printf '  with no input at all, 1176 of 2783 tests skip.\n'
