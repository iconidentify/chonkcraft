...
# verified almost nothing. 1,067 of 2,660 tests skip that way. This prints the
...
if [[ "$wc2_ok" == 1 && "$pack_ok" == 1 && "$opus_ok" == 1 ]]; then
    ...
    printf '  Expect 2660 tests, 26 skipped, and about four minutes of wall time.\n'
    ...
    printf '  with no input at all, 1067 of 2660 tests skip.\n'
