...
# verified almost nothing. 1,021 of 2,591 tests skip that way. This prints the
...
if [[ "$wc2_ok" == 1 && "$pack_ok" == 1 && "$opus_ok" == 1 ]]; then
    ...
    printf '  Expect 2591 tests, 25 skipped, and about four minutes of wall time.\n'
    ...
    printf '  with no input at all, 1021 of 2591 tests skip.\n'
