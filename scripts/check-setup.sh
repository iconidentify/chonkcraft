...
# verified almost nothing. 1,205 of 2,823 tests skip that way. This prints the
...
if [[ "$wc2_ok" == 1 && "$pack_ok" == 1 && "$opus_ok" == 1 ]]; then
    ...
    printf '  Expect 2823 tests, normally 27 skipped, and about five minutes of wall time.\n'
    ...
    printf '  with no input at all, 1205 of 2823 tests skip.\n'
