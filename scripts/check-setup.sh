...
# verified almost nothing. 1,173 of 2,777 tests skip that way. This prints the
...
if [[ "$wc2_ok" == 1 && "$pack_ok" == 1 && "$opus_ok" == 1 ]]; then
    ...
    printf '  Expect 2777 tests, 26 skipped, and about four minutes of wall time.\n'
    ...
    printf '  with no input at all, 1173 of 2777 tests skip.\n'
