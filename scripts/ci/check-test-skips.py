...
floor and the measured data-free inventory are:
    ...
    authenticated profile      3040 tests,   27 skipped
    no external input          3040 tests, 1385 skipped
...
PROFILES: dict[str, dict[str, tuple[int, int]]] = {
    ...
    "data-free": {
        ...
        # Three dragon Attack/Move and save-continuation referees need BNE.
        "engine": (2088, 1036),
        ...
        # data-free skips. The multiplayer speed and desync changes add
        # four engine and four desktop referees; three presentation checks
