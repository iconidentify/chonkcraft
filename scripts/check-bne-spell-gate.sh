...
CHONKCRAFT_ASSET_PACK="${asset_pack}" "${repo_root}/scripts/run-tests.sh" -pl engine -am \
  '-Dtest=OffensiveSpellTest,SpellCastingTest,SpellRealDataTest,SpellBuffTest,RareSpellBehaviorTest,BattleNetSpellBehaviorTest,BattleNetSpellAnimationRealDataTest' \
...
expected = {
    ...
    "net.chonkbase.chonkcraft.engine.BattleNetSpellBehaviorTest": 4,
    "net.chonkbase.chonkcraft.engine.BattleNetSpellAnimationRealDataTest": 1,
}
...
print("spell referee inventory: 41 pass, 0 skipped")
PY
