...
4. Read the current substantive command debts and all missing generated/native cells. Treat 132/134 comparable as the starting measurement, not 132/240 completion. The current two are Attack residual offset and Return Goods resource lifecycle; rerun the worklist rather than trusting this prose if HEAD moves.
