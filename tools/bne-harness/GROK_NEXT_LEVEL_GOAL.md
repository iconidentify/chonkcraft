...
4. Read the current substantive command debts and all missing generated/native cells. Treat 133/134 comparable as the starting measurement, not 133/240 completion. The current remaining executed debt is Return Goods resource lifecycle; rerun the worklist rather than trusting this prose if HEAD moves.
