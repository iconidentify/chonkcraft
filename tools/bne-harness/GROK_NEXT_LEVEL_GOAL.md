...
4. Read the current substantive command debts and all missing generated/native cells. Treat 131/134 comparable as the starting measurement, not 131/240 completion. The current three are Attack residual offset, Repair terminal delay, and Return Goods resource lifecycle; rerun the worklist rather than trusting this prose if HEAD moves.
