...
either way. With nothing configured, 681 of 2,118 tests skip and
...
Asserts the `full` profile: **17 skips of 2,118**, re-measured after the native
...
second case is the one worth catching: it is how 681 tests came to be skippable
