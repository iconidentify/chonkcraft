...
It asserts 1,060 skips, so 1,580 tests actually run without exposing licensed
media to public pull-request code. The authenticated lane asserts 27 skips out
of 2,640 tests. Tests backed by retail sequences deliberately join the hosted
