...
It asserts 1,190 skips, so 1,615 tests actually run without exposing licensed
media to public pull-request code. The authenticated lane asserts 27 skips out
of 2,805 tests. Tests backed by retail sequences deliberately join the hosted
