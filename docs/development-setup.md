...
It asserts 1,127 skips, so 1,597 tests actually run without exposing licensed
media to public pull-request code. The authenticated lane asserts 26 skips out
of 2,724 tests. Tests backed by retail sequences deliberately join the hosted
