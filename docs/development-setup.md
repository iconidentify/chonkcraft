...
It asserts 1,059 skips, so 1,589 tests actually run without exposing licensed
media to public pull-request code. The authenticated lane asserts 26 skips out
of 2,648 tests. Tests backed by retail sequences deliberately join the hosted
