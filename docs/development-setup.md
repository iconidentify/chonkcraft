...
It asserts 1,077 skips, so 1,593 tests actually run without exposing licensed
media to public pull-request code. The authenticated lane asserts 26 skips out
of 2,670 tests. Tests backed by retail sequences deliberately join the hosted
