...
It asserts 1,180 skips, so 1,608 tests actually run without exposing licensed
media to public pull-request code. The authenticated lane asserts 26 skips out
of 2,788 tests. Tests backed by retail sequences deliberately join the hosted
