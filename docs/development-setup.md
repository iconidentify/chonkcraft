...
It asserts 1,153 skips, so 1,598 tests actually run without exposing licensed
media to public pull-request code. The authenticated lane asserts 26 skips out
of 2,751 tests. Tests backed by retail sequences deliberately join the hosted
