...
It asserts 1,382 skips, so 1,655 tests actually run without exposing licensed
media to public pull-request code. The authenticated lane asserts 27 skips out
of at least 3,037 tests; a development machine with the three private playtest-save
