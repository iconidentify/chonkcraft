...
It asserts 1,345 skips, so 1,647 tests actually run without exposing licensed
media to public pull-request code. The authenticated lane asserts 27 skips out
of at least 2,992 tests; a development machine with the three private playtest-save
