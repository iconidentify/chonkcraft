...
The test suite is **2,785 tests**. On a fully configured CI machine 26 skip; with
no external inputs 1,178 do. Both numbers matter and the difference between them is the
