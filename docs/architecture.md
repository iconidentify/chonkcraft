...
The test suite is **2,830 tests**. On a fully configured CI machine 27 skip; with
no external inputs 1,208 do. Both numbers matter and the difference between them is the
