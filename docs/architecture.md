...
The test suite is **2,790 tests**. On a fully configured CI machine 26 skip; with
no external inputs 1,182 do. Both numbers matter and the difference between them is the
