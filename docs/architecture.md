...
The test suite is **2,628 tests**. On a fully configured CI machine 25 skip; with
no external inputs 991 do. Both numbers matter and the difference between them is the
