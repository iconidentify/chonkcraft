...
The test suite is **2,118 tests**. On a fully configured machine 17 skip; with
no external inputs 681 do. Both numbers matter and the difference between them is the
