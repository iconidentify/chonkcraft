...
The test suite is **2,788 tests**. On a fully configured CI machine 26 skip; with
no external inputs 1,180 do. Both numbers matter and the difference between them is the
